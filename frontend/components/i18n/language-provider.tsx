...
const translations = {
  fr: {
    ...
    upload: {
      ...
      statusHashing: "Calcul du hash local…",
      ...
      proofHeading: "Preuve #",
      hashLabel: "Hash :",
      normalizedHashLabel: "Hash normalisé :",
      ...
      clientHashLabel: "Hash local :",
      metadataHeading: "Métadonnées",
      metadataEmpty: "Aucune métadonnée fournie",
    },
    verify: {
      ...
      statusNotFound: "Aucune preuve correspondante.",
    ...
    dashboard: {
      ...
      activitySubtitle: "Chaque action (génération, vérification, ancrage) apparaît ici en temps réel.",
      activityEmpty: "Aucune activité récente — certifiez votre première création !",
      activityTimeLabel: "À",
      activityMetadataLabel: "Détails",
    },
    pricing: {
      ...
      tokenLabel: "Jeton d’accès (Bearer OAuth2)",
      tokenPlaceholder: "eyJhbGciOiJI…",
      rememberToken: "Mémoriser ce token sur cet appareil",
      actionCheckout: "Créer une session Stripe",
      statusNeedToken: "Ajoutez un token d’accès valide pour lancer le paiement.",
      statusLoading: "Création de la session Stripe…",
      statusReady: "Session prête pour le plan {{plan}}",
      statusError: "Erreur Stripe : {{message}}",
      openCheckout: "Ouvrir Stripe Checkout",
      helper: "Le token n’est jamais stocké côté serveur et reste chiffré dans votre navigateur.",
  ...
  en: {
    ...
    upload: {
      ...
      statusHashing: "Computing local hash…",
      ...
      proofHeading: "Proof #",
      hashLabel: "Hash:",
      normalizedHashLabel: "Normalized hash:",
      ...
      clientHashLabel: "Local hash:",
      metadataHeading: "Metadata",
      metadataEmpty: "No metadata provided",
    },
    verify: {
      ...
      statusNotFound: "No matching proof found.",
    ...
    dashboard: {
      ...
      activityTitle: "Activity journal",
      activitySubtitle: "Every proof, verification, and anchor is traced in real time.",
      activityEmpty: "No activity yet—create your first proof!",
      activityTimeLabel: "At",
      activityMetadataLabel: "Metadata",
    },
    pricing: {
      ...
      tokenLabel: "Access token (Bearer OAuth2)",
      tokenPlaceholder: "eyJhbGciOiJI…",
      rememberToken: "Remember this token on this device",
      actionCheckout: "Create a Stripe session",
      statusNeedToken: "Add a valid access token to launch the checkout.",
      statusLoading: "Generating the Stripe session…",
      statusReady: "Session ready for the {{plan}} plan",
      statusError: "Stripe error: {{message}}",
      openCheckout: "Open Stripe Checkout",
      helper: "The token remains encrypted in your browser and never leaves your device.",
